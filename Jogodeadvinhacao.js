let numerojogo = Math.floor((Math.random() * 50) + 1)
...
console.log("Nesse jogo, o programa irá criar um número aleatório entre 1 e 50, e você terá 10 chances para acertar qual é esse número.")
